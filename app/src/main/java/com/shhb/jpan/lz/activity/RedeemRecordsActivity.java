 ...
 */
public class RedeemRecordsActivity extends BaseActivity implements View.OnClickListener{
    ...
    class JsObject{
        ...
        public void render(String result){
            ...
            okHttpUtils.postEnqueue(Constants.GET_REDEEM_RECORDS_INFO, new Callback() {
                @Override
